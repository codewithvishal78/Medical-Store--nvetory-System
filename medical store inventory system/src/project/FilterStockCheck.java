...
public class FilterStockCheck extends javax.swing.JFrame {
   ...
   String[]arr;
    ...
    {   jPanel6.setVisible(true);
        ...
        if(i==1)
        {
           PreparedStatement ps=conn.prepareStatement("select medicines, available from medicine where medicines=?");
           ps.setString(1, str);
        ...
        else if(i==2)
        {
           ...
           PreparedStatement ps=conn.prepareStatement("select medicines, available from medicine where available " + symbol+ "?");
           ps.setInt(1,count);
           ResultSet rs=ps.executeQuery();
           jTable1.setModel(DbUtils.resultSetToTableModel(rs)); 
        }
        ...
        {
          PreparedStatement ps=conn.prepareStatement("select medicines, available from medicine where name like ?");
           ps.setString(1, str+"%");
           ResultSet rs=ps.executeQuery();
           jTable1.setModel(DbUtils.resultSetToTableModel(rs));   
        }
